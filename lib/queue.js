...
module.exports = class Queue {
    ...
    async getMessage () {
        ...
        try {
            ...
            console.log(colors.green('Get Message: ', data.Message.MessageBody));
        } catch (err) {
            console.log(colors.gray('Empty Content: ', this.name));
        }
        return data;
    }
    ...
    async deleteMessage (handle) {
        ...
        console.log(colors.blue('Message Removed: ', handle));
    }
};
